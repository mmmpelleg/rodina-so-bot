...
let manytags = ["ПРА-ВО","ПРАВ-ВО","ПРАВО","ГИБДД","ГУВД","ФСБ","МЗЮ","ВМУ","МЗ-Ю","МЗ-А","АРМИЯ","МРЭО","ЦБ","ЖП","РЦ","СМИ","ФМ","СТ","СБ","ЧК","КМ","УМ","РМ",];
let rolesgg = ["✦ Сотрудник Пра-ва ✦", "✦ Сотрудник МВД ✦", "✦ Сотрудник ФСБ ✦", "✦ Сотрудник Мин.Здрава ✦", "✦ Боец Армии ✦", "✦ Сотрудник Центра.Лицензий ✦", "✦ Сотрудник Банка ✦", "✦ Сотрудник Радиоцентра ✦", "✦ Бандит ОПГ ✦", "✦ Бандит Мафии ✦",]
let krominal = ["✦ Бандит ОПГ ✦", "✦ Бандит Мафии ✦"]
let gos = ["✦ Сотрудник Пра-ва ✦", "✦ Сотрудник МВД ✦", "✦ Сотрудник ФСБ ✦", "✦ Сотрудник Мин.Здрава ✦", "✦ Боец Армии ✦", "✦ Сотрудник Центра.Лицензий ✦", "✦ Сотрудник Банка ✦", "✦ Сотрудник Радиоцентра ✦"]
